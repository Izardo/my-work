# This program requests an string input from the 
# user and outputs every second character in reverse
# order. 
# Author: Isabella Doyle

string = input("Enter text:")   # request string input from user
